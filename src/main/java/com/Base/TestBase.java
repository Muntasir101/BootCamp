...
public class TestBase {
    ...
    public static String browserStackKey = "NcKxkDU3bChUX2wrzxLD";
    ...
    public void typeOnElementByName(String locator, String value) {
    ...
    public WebElement getElementByName(String locator) {
